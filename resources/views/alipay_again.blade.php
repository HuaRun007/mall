        ...
        <div id="body1" class="show" name="divcontent">
            <dl class="content">
                <dt>商户订单号
                    ：</dt>
                <dd>
                    <input  name="WIDout_trade_no"  value="{{$orderno}}" readonly/>
                </dd>
                <hr class="one_line">
                <dt>订单名称
                    ：</dt>
