    ...
    <div class="x-body">
        <div class="layui-row">
            <form class="layui-form layui-col-md12 x-so">
                ...
                <button type="button" class="layui-btn"  lay-submit="" lay-filter="sreach"  id="product_list_sreachBtn"><i class="layui-icon">&#xe615;</i></button>
            </form>
        </div>
        <table class="layui-table" lay-data="{url:'/admin/getproductlist',page:true,limit:30,toolbar: '#toolbarDemo',id:'product_table'}" lay-filter="product_table">
            <thead>
            <tr>
...
@section('my-js')
    <script type="text/html" id="on_saleTp">
        <input type="checkbox" name="status" value="@{{d.id}}"  lay-skin="switch" lay-text="在售|下架"  lay-filter="switch_test" @{{ d.on_sale == 1 ?'checked' : '' }}>
    </script>
    ...
    <script type="text/html" id="barDemo">
        ...
        <a class="layui-btn layui-btn-xs" lay-event="edit"  onclick="x_admin_show('商品编辑','/admin/product/edit/@{{d.id}}')">编辑</a>
        @endpermission
