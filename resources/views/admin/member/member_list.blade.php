...
@section('content')
    ...
    <div class="x-body">
        ...
        <table class="layui-table"
               lay-data="{url:'/admin/getmember_list',page:true,limit:30,toolbar: '#toolbarDemo',id:'test'}"
               lay-filter="test">
            <thead>
            <tr>
    ...
    <script type="text/html" id="barDemo">
        ...
        <a class="layui-btn layui-btn-xs" lay-event="edit"
           onclick="x_admin_show('会员编辑','/admin/member_edit?id=@{{d.id}}',500,400)">编辑</a>
        @endpermission
    ...
    <script type="text/html" id="titleTpl">
        <input type="checkbox" name="status" value="@{{d.id}}" lay-skin="switch" lay-text="启用|禁用"
               lay-filter="switch_test" @{{ d.status== 1 ?'checked' : '' }}>
    </script>
    @endpermission
    <script>
